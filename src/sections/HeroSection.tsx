...
export default function HeroSection() {
  return (
    <div className="bg-black relative overflow-hidden">
      ...
      <div className="absolute bottom-[-20%] right-[-10%] w-[600px] h-[600px] bg-vivid-blue/10 blur-3xl pointer-events-none rounded-full z-10" />
      ...
      <header className="absolute inset-0 w-full h-20 items-center gap-2 flex p-4 px-8">
        ...
        <p className="text-white font-bold font-lato">Rafaela Souza</p>
      </header>
      ...
      <main className="flex items-center justify-center absolute inset-0">
        <div className="max-w-[700px]">
          ...
          <p className="text-white mt-4 font-lato">
          ...
          <button
            type="button"
            className="bg-vivid-blue p-4 mt-8 text-white font-bold rounded-md flex items-center gap-2 cursor-pointer hover:bg-vivid-blue/90 transition-colors duration-300 ease-in-out shadow-[0_8px_20px_rgba(0,0,0,0.3)]"
          >
            <FaWhatsapp size={22} />
