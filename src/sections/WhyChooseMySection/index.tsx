...
export default function WhyChooseMySection() {
  return (
    <div className="bg-almost-black">
      <div className="pt-26 pb-26 flex flex-col items-center">
        ...
        <div className="mt-32 flex gap-16">
          ...
          <div className="max-w-[520px]">
            <h1 className="text-[32px] font-inter font-bold">
              Por que escolher{" "}
              <span className="text-vivid-blue">minha atuação</span> na defesa
              dos direitos trabalhistas?
            </h1>

            <p className="mt-8 mb-4 font-lato">
              Atuo de forma estratégica e personalizada na defesa de
              trabalhadores que enfrentam conflitos e injustiças no ambiente de
              trabalho. Meu compromisso é garantir que cada cliente tenha acesso
              aos direitos que lhe são devidos, com orientação clara, ética e
            ...
            <p className="font-lato">
              ...
              tratado com atenção aos detalhes, análise cuidadosa da
              documentação e construção de uma estratégia sólida para alcançar o
              melhor resultado.
            </p>
          </div>
        </div>
